...
const DocumentDetailDrawer: React.FC<DocumentDetailDrawerProps> = ({
  ...
  const CopyButton: React.FC<{ onClick: () => void; title?: string }> = ({ onClick, title = 'Copy to clipboard' }) => (
    <Button
      type="text"
      size="small"
      icon={<CopyOutlined />}
  ...
  return (
    <Drawer
      ...
      size={480}
      styles={{
        header: { background: 'var(--bg-secondary)', borderBottom: '1px solid var(--border-color)', padding: '12px 16px' },
          ...
          {document.score !== undefined && (
            <div style={{ marginBottom: 16 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
                ...
                <CopyButton 
                  onClick={() => copyToClipboard(Number(document.score).toFixed(6), 'Similarity Score')}
          ...
          <div>
            ...
            <div style={{ marginBottom: 16 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
                ...
                <CopyButton 
                  onClick={() => copyToClipboard(String(document.primary.value), document.primary.name)}
